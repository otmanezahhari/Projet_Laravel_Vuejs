...
export default {
    ...
    data(){
        return {
            ...
            roles:[],
            resources: [
                {resourceName: 'Créations des roles', read: false, write: false, update: false, delete: false, name: 'assignRole'},
                {resourceName: 'Role', read: false, write: false, update: false, delete: false, name: 'role'},
                {resourceName: 'Utilisateurs', read: false, write: false, update: false, delete: false, name: 'adminUsers'},
                {resourceName: 'Cryptos List', read: false, write: false, update: false, delete: false, name: 'CryptoList'},

                {resourceName: 'Dashboard', read: false, write: false, update: false, delete: false, name: 'DashboardPage'},
                {resourceName: 'Portefeuille', read: false, write: false, update: false, delete: false, name: 'Portefeuille'},
                {resourceName: 'Historique', read: false, write: false, update: false, delete: false, name: 'History'},
